...
//===================================
    ...
    void BlockComponentChangeDirection::interact( Collision& collision, Sprite& sprite, Block& block, BlockType& type, Level& level, EventSystem& events, InventoryLevel& inventory, Camera& camera )
    {
        switch ( direction_ )
        {
