...
MapLayerNeon::MapLayerNeon( Unit::Layer layer_position ) : MapLayer( layer_position ), hue_ ( 0 ), color_ ( { 255, 0, 0, 255 } ) {};
...
void MapLayerNeon::update( LevelState& level_state )
{
	++hue_;
	if ( hue_ > 360 )
	{
...
//
void MapLayerNeon::convertHSVToRGB()
{
