...
:
	Sprite( std::make_unique<SpriteGraphics> ( "sprites/icicle.png", 0, 0, false, false, 0.0, -2, -2, 4, 4 ), x, y + 2, 28, 8, { SpriteType::ICICLE }, 250, 1200, 0, 0, Direction::Horizontal::__NULL, Direction::Vertical::__NULL, nullptr, SpriteMovement::Type::FLOATING, CameraMovement::PERMANENT, true, false )
{};
