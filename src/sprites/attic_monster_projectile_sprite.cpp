...
:
	Sprite( std::make_unique<SpriteGraphics> ( "sprites/attic-rat.png", 88, 0, false, false, 0.0, true, -1, -1, 2, 2 ), x, y, 4, 4, { SpriteType::ENEMY }, 3000, 3000, 0, 0, direction, Direction::Vertical::__NULL, nullptr, SpriteMovement::Type::FLOATING, CameraMovement::DESPAWN_OFFSCREEN, true, false ),
