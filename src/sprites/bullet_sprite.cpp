...
:
	Sprite( std::make_unique<SpriteGraphics> ( "sprites/cowpoker.png", 0, 117, false, false, 0, false, 0, 0, 1, 1 ), x, y, 4, 4, bulletType( heros ), 1600, 3000, 0, 0, Direction::simpleToHorizontal( dir ), Direction::simpleToVertical( dir ), nullptr, SpriteMovement::Type::FLOATING, CameraMovement::DESPAWN_OFFSCREEN, false, true ),
	heros_ ( heros )
{};
