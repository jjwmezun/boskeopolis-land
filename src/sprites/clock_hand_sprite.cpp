...
ClockHandSprite::ClockHandSprite( int x, int y, Direction::Clockwise direction, double speed )
:
    ...
    inner_left_ ( { centerXSubPixels(), centerYSubPixels(), 1, 1 }, centerXSubPixels(), centerYSubPixels(), 4000, (( direction == Direction::Clockwise::COUNTERCLOCKWISE ) ? -speed : speed ), -0.333 ),
    inner_right_ ( { centerXSubPixels(), centerYSubPixels(), 1, 1 }, centerXSubPixels(), centerYSubPixels(), 4000, (( direction == Direction::Clockwise::COUNTERCLOCKWISE ) ? -speed : speed ), 0.333 ),
    outer_left_ ( { centerXSubPixels(), centerYSubPixels(), 1, 1 }, centerXSubPixels(), centerYSubPixels(), Unit::BlocksToSubPixels( 4 ), (( direction == Direction::Clockwise::COUNTERCLOCKWISE ) ? -speed : speed ), -0.0333 ),
    outer_right_ ( { centerXSubPixels(), centerYSubPixels(), 1, 1 }, centerXSubPixels(), centerYSubPixels(), Unit::BlocksToSubPixels( 4 ), (( direction == Direction::Clockwise::COUNTERCLOCKWISE ) ? -speed : speed ), 0.0333 ),
