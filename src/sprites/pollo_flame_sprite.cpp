...
:
	Sprite( std::make_unique<SpriteGraphics> ( "sprites/pollo-picante.png", 128, 12, false, false, 0.0, false, -1, -1, 2, 2 ), x, y, 6, 2, { SpriteType::ENEMY }, 2000, 2000, 0, 0, direction, Direction::Vertical::__NULL, nullptr, SpriteMovement::Type::FLOATING, CameraMovement::DESPAWN_OFFSCREEN, false, false, true )
{};
