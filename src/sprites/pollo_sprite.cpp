...
PolloSprite::PolloSprite( int x, int y, Direction::Horizontal dir_x )
:
	Sprite( std::make_unique<SpriteGraphics> ( "sprites/pollo_no_noko.png", 0, 0, ( dir_x == Direction::Horizontal::RIGHT ), false, 0, false, -1, -6, 2, 7 ), x, y, 22, 22, {}, 500, 3000, 500, 4000, dir_x, Direction::Vertical::__NULL, nullptr, SpriteMovement::Type::GROUNDED, CameraMovement::RESET_OFFSCREEN_AND_AWAY ),
...
void PolloSprite::customInteract( Collision& my_collision, Collision& their_collision, Sprite& them, BlockSystem& blocks, SpriteSystem& sprites, Map& lvmap, Health& health )
{
