...
:
	Sprite( std::make_unique<SpriteGraphics> ( "sprites/cowpoker.png", 0, typeGFX( dir ), false, false, 0, 0, 0, 0, 0 ), x, y, 16, 16, { SpriteType::DEATH_COUNT }, 100, 2000, 0, 0, Direction::Horizontal::__NULL, dir, nullptr, SpriteMovement::Type::FLOATING, CameraMovement::RESET_OFFSCREEN_AND_AWAY, true, true, true, 2.0, map_id ),
	deactivated_ ( false ),
	shoot_time_ ( 0 ),
	shoot_counter_ ( 0 ),
	hp_ ( 4 ),
