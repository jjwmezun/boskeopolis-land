...
:
	Sprite( std::make_unique<SpriteGraphics> ( "sprites/clock.png", 48, 0, false, false, 0.0, -1, -5, 5, 6 ), x, y, 3, 2, {}, 0, 0, 2000, 6000, direction, Direction::Vertical::__NULL, nullptr, SpriteMovement::Type::GROUNDED, CameraMovement::PERMANENT, true, false )
{
    on_ground_ = true;
