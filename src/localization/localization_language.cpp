...
std::u32string LocalizationLanguage::getSaveCorruptionErrorMessage() const
{
    return mezun::charToChar32String( "Your save file has become corrupted & can’t be loaded." );
};