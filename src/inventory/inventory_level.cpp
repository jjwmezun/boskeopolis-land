...
InventoryLevel::InventoryLevel( Difficulty difficulty, int max_hp, bool oxygen_upgrade, bool live_update_gfx, int bg_color )
:
	...
	funds_shown_ (),
	clock_ (),
	graphics_ ( max_hp, live_update_gfx, bg_color )
{};
