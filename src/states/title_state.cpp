...
static const std::string TRAINER_LEVELS[ NUMBER_OF_TRAINER_LEVELS ] = { "city-1", "city-1", "city-1", "city-1" };
...
:
    ...
    level_ ( Level::getIDFromCodeName( getRandomTrainerLevel() ), Difficulty::NORMAL, Health::START_MAX_HP, false, { Unit::WINDOW_WIDTH_PIXELS, CAMERA_HEIGHT, 0, 0, Unit::WINDOW_WIDTH_PIXELS, CAMERA_HEIGHT } )
{
};
