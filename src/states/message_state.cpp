...
:
	...
	message_ ( Text::autoformat( message, Text::DEFAULT_LINE_LENGTH - 4 ), 0, 0, text_color, Text::FontAlign::CENTER, shadow_color, true, Text::DEFAULT_LINE_LENGTH - 4, -1, 1, ( flash ) ? std::make_unique<TextComponentFlashing> ( 4 ) : nullptr ),
