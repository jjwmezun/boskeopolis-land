...
INC = -Igraphics -Itimers -Istates -Isprites -Isprite_components -Isprite_movement -Itext -Igoals -Iblock_conditions -Iblock_components -I/home/jjwmezun/Documents/cpp-projects/boskeopolis-land/ -Ilevels -Iinventory
...
$(OBJDIR_DEBUG)/sprite_system.o: sprite_system.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c sprite_system.cpp -o $(OBJDIR_DEBUG)/sprite_system.o
