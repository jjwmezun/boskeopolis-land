...
$(OBJDIR_DEBUG)/graphics/graphics_object.o: graphics/graphics_object.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c graphics/graphics_object.cpp -o $(OBJDIR_DEBUG)/graphics/graphics_object.o
