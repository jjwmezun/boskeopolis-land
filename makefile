...
INC = -Igraphics -Itimers -Istates -Isprites -Isprite_components -Isprite_movement -Itext -Igoals -Iblock_conditions -Iblock_components -I/home/jjwmezun/Documents/cpp-projects/boskeopolis-land/ -Ilevels -Iinventory -Imezun
...
$(OBJDIR_DEBUG)/levels/map_layer_water.o: levels/map_layer_water.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c levels/map_layer_water.cpp -o $(OBJDIR_DEBUG)/levels/map_layer_water.o
...
$(OBJDIR_DEBUG)/inventory/inventory_health.o: inventory/inventory_health.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c inventory/inventory_health.cpp -o $(OBJDIR_DEBUG)/inventory/inventory_health.o
	
$(OBJDIR_DEBUG)/sprites/cloud_block_sprite.o: sprites/cloud_block_sprite.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c sprites/cloud_block_sprite.cpp -o $(OBJDIR_DEBUG)/sprites/cloud_block_sprite.o
	
$(OBJDIR_DEBUG)/sprites/bouncy_cloud_block_sprite.o: sprites/bouncy_cloud_block_sprite.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c sprites/bouncy_cloud_block_sprite.cpp -o $(OBJDIR_DEBUG)/sprites/bouncy_cloud_block_sprite.o
	
$(OBJDIR_DEBUG)/inventory/oxygen_meter.o: inventory/oxygen_meter.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c inventory/oxygen_meter.cpp -o $(OBJDIR_DEBUG)/inventory/oxygen_meter.o
	
$(OBJDIR_DEBUG)/tileset.o: tileset.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c tileset.cpp -o $(OBJDIR_DEBUG)/tileset.o
	
$(OBJDIR_DEBUG)/graphics/bad_apple_graphics.o: graphics/bad_apple_graphics.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c graphics/bad_apple_graphics.cpp -o $(OBJDIR_DEBUG)/graphics/bad_apple_graphics.o
	
$(OBJDIR_DEBUG)/block_components/block_component_move_water.o: block_components/block_component_move_water.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c block_components/block_component_move_water.cpp -o $(OBJDIR_DEBUG)/block_components/block_component_move_water.o
	
$(OBJDIR_DEBUG)/sprites/lil_pipe_monster_sprite.o: sprites/lil_pipe_monster_sprite.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c sprites/lil_pipe_monster_sprite.cpp -o $(OBJDIR_DEBUG)/sprites/lil_pipe_monster_sprite.o
	
$(OBJDIR_DEBUG)/graphics/player_cart_graphics.o: graphics/player_cart_graphics.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c graphics/player_cart_graphics.cpp -o $(OBJDIR_DEBUG)/graphics/player_cart_graphics.o
	
$(OBJDIR_DEBUG)/block_components/block_component_force_upward.o: block_components/block_component_force_upward.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c block_components/block_component_force_upward.cpp -o $(OBJDIR_DEBUG)/block_components/block_component_force_upward.o
	
$(OBJDIR_DEBUG)/block_components/block_component_kill.o: block_components/block_component_kill.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c block_components/block_component_kill.cpp -o $(OBJDIR_DEBUG)/block_components/block_component_kill.o
	
$(OBJDIR_DEBUG)/sprites/shroud_sprite.o: sprites/shroud_sprite.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c sprites/shroud_sprite.cpp -o $(OBJDIR_DEBUG)/sprites/shroud_sprite.o
