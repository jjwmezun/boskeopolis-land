...
$(OBJDIR_DEBUG)/levels/water_effect.o: levels/water_effect.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c levels/water_effect.cpp -o $(OBJDIR_DEBUG)/levels/water_effect.o
