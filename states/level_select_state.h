...
//===================================
    ...
    class LevelSelectState : public GameState
    {
        ...
        public:
            ...
            static LevelSelectState* continueLevelSelect( EventSystem events, InventoryLevel inventory, Level::LevelName level );
        ...
        private:
            LevelSelectState( Status status, EventSystem events, Inventory inventory, Level::LevelName level );

            static constexpr Level::LevelName DEFAULT_LEVEL = Level::LevelName::LV_CITY_1;
            ...
            SpriteGraphics win_icon_gfx_ = SpriteGraphics( Graphics::SpriteSheet::LVTILESET_UNIVERSAL, 40, 8 );
            SpriteGraphics diamond_gfx_ = SpriteGraphics( Graphics::SpriteSheet::LVTILESET_UNIVERSAL, 48, 0 );
            SpriteGraphics gem_icon_gfx_ = SpriteGraphics( Graphics::SpriteSheet::CHARSET, 32, 16 );
